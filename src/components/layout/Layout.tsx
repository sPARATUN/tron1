      ...
      <header className="rIYD0d _1POjMs _14pLN0 IfuBxn">
        <div className="b_L6f_ eOD671">
          ...
          <nav className="Mwyj41 undefined">
            <div
              className="LJ7GIf wZ_Bne _BTY_Y dzM2XM mwcOHg"
              style={{ cursor: "pointer" }}
            >
              {/* Оставляем только саму кнопку */}
              <TronAuthButton />
            </div>
          </nav>
        </div>
      ...
      <footer className="_99rnTN xpfe1_">
        <div className="b_L6f_">
            ...
            <div className="TGa6sT">
              <div className="j8Gu_5">
                <img
                  ...
                  height="120"
                  decoding="async"
                  src="images/iso-9001-black.58844294.svg"
                />
                <img
                  alt="ISO 27001:2017"
                  loading="lazy"
                  ...
                  height="120"
                  decoding="async"
                  src="images/iso-27001-black.6acb33dc.svg"
                />
              </div>
            </div>
          </div>
          <div className="_8yyV1L">
            ...
            <a
              href="https://t.me/amlcheck_support"
              rel="nofollow"
              className="e4Ejat"
            >
