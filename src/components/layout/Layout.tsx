                    ...
                    <div className="gsp1gS">
                        ...
                        <div className="TGa6sT">
                            <div className="j8Gu_5">
                                <img alt="ISO 9001:215" loading="lazy" width="120" height="120" decoding="async" data-nimg="1" src="images/iso-9001-black.58844294.svg" />
                                <img alt="ISO 27001:2017" loading="lazy" width="120" height="120" decoding="async" data-nimg="1" src="images/iso-27001-black.6acb33dc.svg" />
                            </div>
                        </div>
                    </div>
